...
export default function App() {
    ...
    return (
        <main className="w-[360px] sm:w-[360px] p-[36px] bg-slate-200 rounded-lg shadow-xl text-center">
            ...
            <p className="w-full text-center text-[12px] text-slate-50 fixed bottom-[20px] left-0 text-[400] tracking-widest">&copy; 2022 Built by <a href="https://khalteck.netlify.app" target="_blank" rel="noreferrer" className="underline text-blue-200">Khalid</a></p>
    </main>
    )
}